...
def run():
    with grpc.insecure_channel("grpc:50051") as channel:
        ...
        if rpc_call == "1":
            ...
            delayed_reply = stub.ChattyClientSaysHello(get_client_strem_requests())
            
            print("ChattyClientSaysHello Response Received :")
            print(delayed_reply)
        elif rpc_call == "4":
            responses = stub.InteractingHello(get_client_strem_requests())
